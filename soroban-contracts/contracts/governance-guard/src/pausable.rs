...
//! `admin` is deliberate too: the signer set is M-of-N, is rotatable
//! through the timelocked flow in the crate root, and survives the loss of
//! any one key. An incident is exactly when a single non-rotatable admin
//! key is least trustworthy.
//!
//! ## Scopes
//!
